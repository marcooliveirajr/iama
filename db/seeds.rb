...
HealthTerminology.find_or_create_by({:code_tuss => 20102011, :description_tuss => "Holter De 24 Horas - 2 Ou Mais Canais - Analógico", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1 })
HealthTerminology.find_or_create_by({:code_tuss => 20102038, :description_tuss => "Monitorização Ambulatorial Da Pressão Arterial - Mapa (24 Horas)", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 2})
HealthTerminology.find_or_create_by({:code_tuss => 20102070, :description_tuss => "Tilt Teste", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20102089, :description_tuss => "Sistema Holter - 12 Horas - 1 Canal", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 3})
HealthTerminology.find_or_create_by({:code_tuss => 20103018, :description_tuss => "Adaptação E Treinamento De Recursos Ópticos Para Visão Subnormal (Por Sessão) -", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
...
HealthTerminology.find_or_create_by({:code_tuss => 20103107, :description_tuss => "Atendimento Fisiátrico No Pré E Pós-Parto", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103115, :description_tuss => "Atividade Reflexa Ou Aplicação De Técnica Cinesioterápica Específica", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103131, :description_tuss => "Biofeedback Com Emg", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103140, :description_tuss => "Bloqueio Fenólico, Alcoólico Ou Com Toxina Botulínica (De Pontos Motores) - Por Membro", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103182, :description_tuss => "Desvios Posturais Da Coluna Vertebral", :category_tuss => "Procedimentos Clínicos", :size => 0, :version_id => 1})
