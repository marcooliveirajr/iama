...
HealthTerminology.find_or_create_by({:code_tuss => 20103107, :description_tuss => "Atendimento Fisiátrico No Pré E Pós-Parto", :category_tuss => "Procedimentos Clínicos", :size => 0, :version => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103115, :description_tuss => "Atividade Reflexa Ou Aplicação De Técnica Cinesioterápica Específica", :category_tuss => "Procedimentos Clínicos", :size => 0, :version => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103131, :description_tuss => "Biofeedback Com Emg", :category_tuss => "Procedimentos Clínicos", :size => 0, :version => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103140, :description_tuss => "Bloqueio Fenólico, Alcoólico Ou Com Toxina Botulínica (De Pontos Motores) - Por Membro", :category_tuss => "Procedimentos Clínicos", :size => 0, :version => 1})
HealthTerminology.find_or_create_by({:code_tuss => 20103182, :description_tuss => "Desvios Posturais Da Coluna Vertebral", :category_tuss => "Procedimentos Clínicos", :size => 0, :version => 1})