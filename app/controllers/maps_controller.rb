class MapsController < ApplicationController
  ...
  private
    ...
    def map_params
      params.require(:map).permit(:time_surgery, :hospital_id, :bedroom_id, :patient_id, :health_terminology_id, :surgeon_id, :anesthetist_id, :health_insurance_id, :note, :receipt_id, :payment_method_id)
    end
