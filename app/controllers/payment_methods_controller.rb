class PaymentMethodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_method.save
        format.html { redirect_to @payment_method, notice: 'Método de Pagamento criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @payment_method.update(payment_method_params)
        format.html { redirect_to @payment_method, notice: 'Método de Pagamento atualizado com sucesso.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_methods_url, notice: 'Método de Pagamento excluído com sucesso.' }
