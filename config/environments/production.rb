...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "clinicaiama_production"
  ...
  config.action_mailer.default_url_options = { host: 'www.clinicaiama.com.br', protocol: 'https' }
  config.action_mailer.smtp_settings = {
    address:              ENV.fetch('SMTP_HOST',     'smtp.gmail.com'),
    port:                 ENV.fetch('SMTP_PORT',     '587').to_i,
    domain:               'clinicaiama.com.br',
